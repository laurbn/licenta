...
public class Atan2Translator implements Translator {
    @Override
    public boolean isApplicableToRAPID(String instruction) {
        return instruction.startsWith("ATan2")&instruction.contains("ATan2"); //solve case sensitive
    }

    @Override
    public boolean isApplicableToVPlus(String instruction) {
        return instruction.startsWith("ATAN2")&instruction.contains("ATAN2");
    }
    ...
    public void translateRAPID(List<String> instructions, Integer index) {
        ...
        instructions.set(index, "ATAN2("+testValue1+", "+testValue2+")");
